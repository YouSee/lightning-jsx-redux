...
interface LightningAttributesText<LightningElementText>
  ...
  updated?: (newState: any, oldState: any, self: LightningElementText) => void;
  firstActive?: (
    currentState: any,
    currentProps: any,
...
interface LightningAttributesRect<LightningElementRect>
  extends LightningBasicElementAttributes {
  rect: boolean;
  updated?: (newState: any, oldState: any, self: LightningElementRect) => void;
  firstActive?: (
    currentState: any,
    currentProps: any,
...
interface LightningAttributesView<LightningElementView>
  extends LightningBasicElementAttributes {
  updated?: (newState: any, oldState: any, self: LightningElementView) => void;
  firstActive?: (
    currentState: any,
    currentProps: any,
...
interface LightningAttributesImage<LightningElementImage>
  extends LightningBasicElementAttributes {
  src?: string;
  updated?: (newState: any, oldState: any, self: LightningElementImage) => void;
  firstActive?: (
    currentState: any,
    currentProps: any,
...
namespace JSX {
  ...
  interface IntrinsicElements {
    view: LightningAttributesView<LightningElementView>;
    rect: LightningAttributesRect<LightningElementRect>;
    text: LightningAttributesText<LightningElementText>;
    image: LightningAttributesImage<LightningElementImage>;
  }
}
